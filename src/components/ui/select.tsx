...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ref={ref}
    className={cn(
      'flex w-full items-center justify-between outline-none h-10 rounded-lg border-gray-e8e border px-3 py-2 focus:border-black-44 transition-all text-sm text-secondary',
      className
    )}
    {...props}
  >
